...
void PrintMatchedBenignRaces();
    ...
    //JEFF
#define TSAN_DEBUG_OUTPUT 0
#define TSAN_DEBUG_OUTPUT3 0
    
#define TSAN_DEBUG_OUTPUT4 1
    
#if defined(TSAN_DEBUG_OUTPUT4) && TSAN_DEBUG_OUTPUT4 >= 1
# define DPrintf4 Printf
#else
# define DPrintf4(...)
#endif
    
#if defined(TSAN_DEBUG_OUTPUT3) && TSAN_DEBUG_OUTPUT3 >= 1

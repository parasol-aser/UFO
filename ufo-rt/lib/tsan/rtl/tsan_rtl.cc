...
void MemoryAccess(ThreadState *thr, uptr pc, uptr addr,
  ...
  aser::ufo::on_mem_acc(thr,pc,addr,kAccessSizeLog,kAccessIsWrite);//JEFF
  return;//FASTER
...
void FuncEntry(ThreadState *thr, uptr pc) {
  ...
  aser::ufo::enter_func(thr,pc);//JEFF
}
